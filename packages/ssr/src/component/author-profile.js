...
const { AuthorProfileProvider } = require("@times-components-native/provider/rnw");
const {
  ContextProviderWithDefaults
} = require("@times-components-native/context/rnw");
const AuthorProfile = require("@times-components-native/author-profile/rnw").default;
